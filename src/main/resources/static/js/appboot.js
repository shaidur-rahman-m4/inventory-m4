...
$(function() {
	 ...
	 * Every page should have an attribute data-controller which makes the page
	 * unique. If any page needs to do something after page loading, just write
	 * init event handling of the html tag which has data-controller attribute.
	 */
	...
	$("#headerconfirmbutton").on("mainpagesubmitinitialise",
			m4.mainpagesubmitdefault);
